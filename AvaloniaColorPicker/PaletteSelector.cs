...
{
    internal class PaletteSelector : UserControl
    {
        ...
        public static string PaletteDirectory { get; } = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), PaletteID, "ColorPicker");

        internal ColorPicker Owner { get; set; }
        ...
        public static readonly StyledProperty<Func<Color, Color>> ColourBlindnessFunctionProperty = AvaloniaProperty.Register<PaletteSelector, Func<Color, Color>>(nameof(ColourBlindnessFunction), col => col);

        public Func<Color, Color> ColourBlindnessFunction
        {
